...
const calcTdee = (event) => {
  ...
  document.querySelector("#resultValue").textContent = ` ${grundumsatz.toFixed(
    0
  )} kcal`; // Der Grundumsatz wird in #resultValue ausgegeben
  document.querySelector(
    "#resultValuePal"
  ).textContent = ` ${gesamtumsatz.toFixed(0)} kcal`; // Der Gesamtumsatz wird in #resultValuePal ausgegeben
};
